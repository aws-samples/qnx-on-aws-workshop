...
ワークショップには、**Kiro IDE** を使用したモダンな QNX 開発も含まれています。

* **Kiro IDE 統合**: QNX Toolkit 拡張機能によるクロスプラットフォーム開発と自動ビルド/デプロイメントを備えたモダンな IDE 体験
* **AI 搭載開発**: コードの理解、拡張、最適化、トラブルシューティングのための組み込み AI コーディングエージェント
